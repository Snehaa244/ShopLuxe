...
const Product = () => {
  ...
  return (
    <section className="text-gray-600 bg-neutral-100 body-font overflow-hidden">
        ...
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          <img alt={product?.title} className="lg:w-1/2 w-full lg:h-auto max-h-[600px] h-64 object-contain object-center rounded" src={product?.image}/>
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              <h2 className="text-sm title-font text-blue-900 tracking-widest uppercase">{product?.category}</h2>
              ...
              <div className="flex justify-between items-center">
                ...
                <div className=' flex'>
                  <button className="flex ml-auto text-white bg-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-yellow-500 rounded mr-2" onClick={() => handleCart(product, true)}>Buy it now</button>
                  <button className="flex ml-auto border border-red-500 py-2 px-6 focus:outline-none hover:bg-red-800 hover:text-white rounded" onClick={() => handleCart(product)}>Add to cart</button>
                </div>
