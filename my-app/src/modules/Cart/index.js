    ...
    <div className="container mx-auto mt-10">
      <div className="flex shadow-md my-10">
        <div className="w-3/4 bg-white px-10 py-10">
          ...
          <Link to={'/products'} className="flex font-semibold text-orange-900 text-sm mt-10">
        ...
        <div id="summary" className="w-1/4 px-8 py-10">
          ...
          <button className="bg-orange-500 hover:bg-red-600 px-5 py-2 text-sm text-white uppercase">Apply</button>
          <div className="border-t mt-8">
            <div className="flex font-semibold justify-between py-6 text-sm uppercase">
              <span>Total cost</span>
              <span>${(total + 10).toFixed(2)}</span>
            </div>
            <button className="text-white bg-gradient-to-br from-orange-800 to-orange-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-orange-300 dark:focus:ring-orange-600 font-medium rounded-lg text-sm mr-2 px-4 py-2.5 w-full text-center mb-2">Checkout</button>
          </div>
        </div>
